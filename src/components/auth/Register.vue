  ...
  <div class="page-wrapper login-form">
    ...
    <form action="#" @submit.prevent="validateBeforeSubmit">
      ...
      <div class="form-control mb-more">
        ...
        <input type="password" name="password" id="password" class="login-input" :class="{ 'input-error': errors.has('password') }" v-model="password_confirmation" v-validate="'required|min:6'">
        <span class="form-error">{{ errors.first('password') }}</span>
      </div>
